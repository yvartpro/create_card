...
export const createOption = async (req, res) => {
  ...
  apiResponse(res, 201, 'Option created successfully', option);
};
...
export const getOptions = async (req, res) => {
  ...
  apiResponse(res, 200, 'Options retrieved', options);
};

export const getOptionById = async (req, res) => {
  const option = await Option.findByPk(req.params.id);
  if (!option) return apiResponse(res, 404, 'Option not found');
  apiResponse(res, 200, 'Option retrieved', option);
};
...
export const updateOption = async (req, res) => {
  ...
  apiResponse(res, 200, 'Option updated', option);
};
...
export const deleteOption = async (req, res) => {
  ...
  apiResponse(res, 200, 'Option deleted');
};
